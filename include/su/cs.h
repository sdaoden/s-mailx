...
public:
	/*! \copydoc{su_cs_ctype} */
	enum ctype{
		ctype_none = su_CS_CTYPE_NONE, /*!< \copydoc{su_CS_CTYPE_NONE} */
		ctype_alnum = su_CS_CTYPE_ALNUM, /*!< \copydoc{su_CS_CTYPE_ALNUM} */
		ctype_alpha = su_CS_CTYPE_ALPHA, /*!< \copydoc{su_CS_CTYPE_ALPHA} */
		ctype_blank = su_CS_CTYPE_BLANK, /*!< \copydoc{su_CS_CTYPE_BLANK} */
		ctype_cntrl = su_CS_CTYPE_CNTRL, /*!< \copydoc{su_CS_CTYPE_CNTRL} */
		ctype_digit = su_CS_CTYPE_DIGIT, /*!< \copydoc{su_CS_CTYPE_DIGIT} */
		ctype_graph = su_CS_CTYPE_GRAPH, /*!< \copydoc{su_CS_CTYPE_GRAPH} */
		ctype_lower = su_CS_CTYPE_LOWER, /*!< \copydoc{su_CS_CTYPE_LOWER} */
		ctype_print = su_CS_CTYPE_PRINT, /*!< \copydoc{su_CS_CTYPE_PRINT} */
		ctype_punct = su_CS_CTYPE_PUNCT, /*!< \copydoc{su_CS_CTYPE_PUNCT} */
		ctype_space = su_CS_CTYPE_SPACE, /*!< \copydoc{su_CS_CTYPE_SPACE} */
		ctype_upper = su_CS_CTYPE_UPPER, /*!< \copydoc{su_CS_CTYPE_UPPER} */
		ctype_white = su_CS_CTYPE_WHITE, /*!< \copydoc{su_CS_CTYPE_WHITE} */
		ctype_xdigit = su_CS_CTYPE_XDIGIT /*!< \copydoc{su_CS_CTYPE_XDIGIT} */
	};
