 ...
 * \remarks{Introduces a block scope.} */
#define su_STRUCT_ZERO_UNTIL(T,P,F) su_CC_MEM_ZERO(P, sizeof(T) - su_FIELD_OFFSETOF(T, F))
...
#define su_STRUCT_ZERO_FROM_UNTIL(T,P,F1,FN) \
	su_CC_MEM_ZERO(&su_S(char*,su_S(void*,P))[su_FIELD_OFFSETOF(T, F1)], sizeof(T) - su_FIELD_OFFSETOF(T, FN))
