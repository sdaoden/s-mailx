...
struct mx_cmd_arg_ctx{
	...
	BITENUM_IS(u8,mx_scope) cac_scope; /* Desired scope, ... */
	BITENUM_IS(u8,mx_scope) cac_scope_vput; /* .cac_vput scope, ... */
	BITENUM_IS(u8,mx_scope) cac_scope_pp; /* positional parameter scope */
	u8 cac__pad[1];
