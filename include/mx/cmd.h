...
enum mx_cmd_arg_desc_flags{
	...
	mx__CMD_ARG_DESC_TYPE_MASK = mx_CMD_ARG_DESC_SHEXP | mx__CMD_ARG_DESC_TYPE_LIST_MASK,
...
EXPORT boole mx_cmd_arg_parse(struct mx_cmd_arg_ctx *cacp, boole skip_aka_dryrun);
 ...
 * skip_aka_dryrun is passed through to shell expression scanner */
EXPORT int getrawlist(boole wysh, boole skip_aka_dryrun, char **res_dat, uz res_size, char const *line, uz linesize); /* TODO v15 */
