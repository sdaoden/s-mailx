...
static struct a_aux_err_map const a_aux_err_map[] = {
   ...
   {2819930u, 238u, 709u, a_X(n_ERR_LOOP)},
   {93913581u, 243u, 743u, a_X(n_ERR_MFILE)},
   {94129275u, 249u, 763u, a_X(n_ERR_MLINK)},
   {3994289122u, 255u, 778u, a_X(n_ERR_MSGSIZE)},
   {1447334482u, 263u, 795u, a_X(n_ERR_MULTIHOP)},
   {1614709027u, 272u, 814u, a_X(n_ERR_NAMETOOLONG)},
   {457778655u, 284u, 833u, a_X(n_ERR_NETDOWN)},
   {2238032682u, 292u, 849u, a_X(n_ERR_NETRESET)},
   {1901584685u, 301u, 885u, a_X(n_ERR_NETUNREACH)},
   {95099502u, 312u, 908u, a_X(n_ERR_NFILE)},
   {3148715213u, 318u, 938u, a_X(n_ERR_NOBUFS)},
   {3148765751u, 325u, 964u, a_X(n_ERR_NODATA)},
   {95417276u, 332u, 982u, a_X(n_ERR_NODEV)},
   {95418660u, 338u, 1016u, a_X(n_ERR_NOENT)},
   {3148826242u, 344u, 1049u, a_X(n_ERR_NOEXEC)},
   {95425911u, 351u, 1067u, a_X(n_ERR_NOLCK)},
   {3149061771u, 357u, 1086u, a_X(n_ERR_NOLINK)},
   {95427068u, 364u, 1108u, a_X(n_ERR_NOMEM)},
   {95427524u, 370u, 1131u, a_X(n_ERR_NOMSG)},
   {1757238308u, 376u, 1158u, a_X(n_ERR_NOPROTOOPT)},
   {95433955u, 387u, 1181u, a_X(n_ERR_NOSPC)},
   {2891938u, 393u, 1205u, a_X(n_ERR_NOSR)},
   {95434102u, 398u, 1229u, a_X(n_ERR_NOSTR)},
   {95434268u, 404u, 1249u, a_X(n_ERR_NOSYS)},
   {849096351u, 410u, 1274u, a_X(n_ERR_NOTCONN)},
   {3149343664u, 418u, 1298u, a_X(n_ERR_NOTDIR)},
   {2252678240u, 425u, 1314u, a_X(n_ERR_NOTEMPTY)},
   {1701688472u, 434u, 1334u, a_X(n_ERR_NOTOBACCO)},
   {849670977u, 444u, 1371u, a_X(n_ERR_NOTSOCK)},
   {3149360393u, 452u, 1402u, a_X(n_ERR_NOTSUP)},
   {95435198u, 459u, 1426u, a_X(n_ERR_NOTTY)},
   {2901406u, 465u, 1457u, a_X(n_ERR_NXIO)},
   {4187911192u, 470u, 1479u, a_X(n_ERR_OPNOTSUPP)},
   {1799919444u, 480u, 1503u, a_X(n_ERR_OVERFLOW)},
   {2952884u, 489u, 1545u, a_X(n_ERR_PERM)},
   {2957166u, 494u, 1569u, a_X(n_ERR_PIPE)},
   {97909396u, 499u, 1581u, a_X(n_ERR_PROTO)},
   {885215854u, 505u, 1596u, a_X(n_ERR_PROTONOSUPPORT)},
   {2666051990u, 520u, 1619u, a_X(n_ERR_PROTOTYPE)},
   {99668781u, 530u, 1650u, a_X(n_ERR_RANGE)},
   {3035258u, 536u, 1667u, a_X(n_ERR_ROFS)},
   {101388609u, 541u, 1688u, a_X(n_ERR_SPIPE)},
   {3074352u, 547u, 1701u, a_X(n_ERR_SRCH)},
   {101523513u, 552u, 1717u, a_X(n_ERR_STALE)},
   {3100815u, 558u, 1739u, a_X(n_ERR_TIME)},
   {832152875u, 563u, 1753u, a_X(n_ERR_TIMEDOUT)},
   {3394827470u, 572u, 1773u, a_X(n_ERR_TXTBSY)},
   {1100483414u, 579u, 1788u, a_X(n_ERR_WOULDBLOCK)},
   {3238871u, 590u, 1810u, a_X(n_ERR_XDEV)},
};
#undef a_X

#define a_AUX_ERR_REV_ILL 81u
