...
#define a_CMD_DEFAULT_IDX 97
#define a_CMD_COUNT 207
...
#define a_X a_CMD_COUNT
	...
	/* 0x4A */ a_X, a_X, 78, 82, 99,
	/* 0x4F */ a_X, 103, a_X, 118, 129,
	/* 0x54 */ 155, 183, a_X, a_X, a_X,
	/* 0x59 */ a_X, 205, a_X, a_X, a_X,
	/* 0x5E */ a_X, a_X, a_X, 5, 10,
	/* 0x63 */ 11, 26, 37, 49, 66,
	/* 0x68 */ 68, 74, a_X, a_X, 79,
	/* 0x6D */ 83, 97, a_X, 104, 110,
	/* 0x72 */ 111, 130, 156, 162, 196,
	/* 0x77 */ 202, 203, a_X, 206, a_X,
	/* 0x7C */ 4, a_X, a_X, a_X,
#undef a_X
};
