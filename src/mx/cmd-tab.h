...
#define EM mx_CMD_ARG_EM
	...
	{"=", &c_pdot, (A | HG | M | V | X | EM | TARG), 0, MMNDEL, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_pdot),
...
{"copy", &c_copy, (A | M | EM | TARG), 0, 0, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_copy),
	...
	{"certsave",
	 ...
	 NIL,
#endif
	 (A | M | TARG), 0, MMNDEL, a_CMD_CAD_CERTSAVE,
...
{"chdir", &c_chdir, (M | TWYSH), 0, 1, NIL,
	...
	{"collapse", &c_collapse, (A | M | TMSGLST), 0, 0, NIL,
...
{"delete", &c_delete, (A | M | W | P | TMSGLST), 0, MMNDEL, NIL,
	 N_("(d) Delete <msglist>")},
{"discard", &c_ignore, (M | TWYRA), 0, MAC, NIL,
	...
	{"dotmove", &c_dotmove, (A | M | TSTRING), 1, 1, NIL,
	 N_("Move the dot up <-> or down <+> by one")},
	{"dp", &c_deltype, (A | M | W | TMSGLST), 0, MMNDEL, NIL,
	 N_("Delete [<msglist>]/\"dot\", then perform `next'")},
	{"dt", &c_deltype, (A | M | W | TMSGLST), 0, MMNDEL, NIL,
	 N_("Delete [<msglist>]/\"dot\", then perform `next'")},
...
{"from", &c_from, (A | M | TMSGLST), 0, MMNORM, NIL,
...
{"headers", &c_headers, (A | M | TMSGLST), 0, MMNDEL, NIL,
	...
	{"hold", &c_preserve, (A | M | SC | W | TMSGLST), 0, MMNDEL, NIL,
...
{"localopts", &c_localopts, (O | M | X | NMAC | NOHIST | TWYSH), 1, 2, NIL,
 N_("Please use the \"local\" command modifier instead")},
	...
	{"Mail", &c_Sendmail, (I | L | LNMAC | R | SC | EM | TSTRING), 0, 0, NIL,
	...
	{"mbox", &c_mboxit, (A | M | W | TMSGLST), 0, MMNDEL, NIL,
	...
	{"mimeview", &c_mimeview, (A | I | EM | M | TMSGLST), 0, MMNDEL, NIL,
	...
	{"More", &c_More, (A | M | TMSGLST), 0, MMNDEL, NIL,
...
{"next"/*--MKTAB-DFL--*/, &c_next, (A | M | TNDMLST), 0, MMNDEL, NIL,
	...
	{"New", &c_unread, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as not being read")},
	{"new", &c_unread, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as not being read")},
	{"newmail", &c_newmail, (A | M | T | NOHOOK | TWYSH), 0, 0, NIL,
...
{"Print", &c_Type, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("(P) Like `print', but bypass `headerpick'")},
{"print", &c_type, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("(p) Type [all members of <msglist>], honour `headerpick'")},
	{"Page", &c_More, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Invoke $PAGER [on <msglist>]")},
	{"page", &c_more, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Invoke $PAGER [on <msglist>]")},
	{"Pipe", &c_Pipe, (A | M | TARG), 0, MMNDEL, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_pipe),
	 N_("Like `pipe', but do not honour `headerpick'")},
	{"pipe", &c_pipe, (A | M | TARG), 0, MMNDEL, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_pipe),
	 N_("(pi) Pipe [<msglist>] to [<command>], honour `headerpick'")},
	{"preserve", &c_preserve, (A | M | SC | W | TMSGLST), 0, MMNDEL, NIL,
...
{"respondsender", &c_replysender, (O | A | I | L | LNMAC | R | SC | EM | TMSGLST), 0, MMNDEL, NIL,
 N_("Please use `Reply'")},
	...
	{"Save", &c_Save, (A | SC | EM | M | TARG), 0, 0, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_Save),
	 N_("(S) Like `save', but derive `folder' from first sender")},
	{"save", &c_save, (A | EM | M | TARG), 0, 0, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_save),
...
{"set", &c_set, (HG | L | M | X | TWYRA), 0, MAC, NIL,
	...
	{"search", &c_from, (A | M | TMSGLST), 0, MMNORM, NIL,
	 N_("Search for <msglist>, type matching headers")},
	{"Seen", &c_seen, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as seen")},
	{"seen", &c_seen, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as seen")},
	{"setdot", &c_setdot, (A | HG | EM | M | TARG), 0, MMNDEL, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_setdot),
	 N_("Set \"dot\" to the given <msg>")},
{"shell", &c_dosh, (I | S | EM | M | TWYSH), 0, 0, NIL,
	...
	{"Show", &c_show, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Like `Type', but show raw message content of <msglist>")},
	{"show", &c_show, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Like `type', but show raw message content of <msglist>")},
	{"size", &c_messize, (A | M | TMSGLST), 0, MMNDEL, NIL,
...
{"Type", &c_Type, (A | M | TMSGLST), 0, MMNDEL, NIL,
...
{"undelete", &c_undelete, (A | M | P | TMSGLST), MDELETED, MMNDEL, NIL,
...
{"unalias", &c_unalias, (M | TWYSH), 1, MAC, NIL,
	...
	{"uncollapse", &c_uncollapse, (A | M | TMSGLST), 0, 0, NIL,
	...
	{"Unread", &c_unread, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as not being read")},
	{"unread", &c_unread, (A | M | TMSGLST), 0, MMNDEL, NIL,
	 N_("Mark <msglist> as not being read")},
	...
	{"unsort", &c_unsort, (A | M | TMSGLST), 0, 0, NIL,
...
{"visual", &c_visual, (A | I | M | S | TMSGLST), 0, MMNORM, NIL,
	...
	{"write", &c_write, (A | M | TARG), 0, 0, mx_CMD_ARG_DESC_SUBCLASS_CAST(&a_cmd_cad_write),
