...
static char const a_termcap_namedat[] = {
	...
	/* [30]+8, mx_TERMCAP_CMD_cl */ 'c','l',  'c','l','e','a','r','\0',
	/* [38]+5, mx_TERMCAP_CMD_cd */ 'c','d',  'e','d','\0',
	/* [43]+7, mx_TERMCAP_CMD_ho */ 'h','o',  'h','o','m','e','\0',
	/* [50]+5, mx_TERMCAP_CMD_BE */ '\0','\0',  'B','E','\0',
	/* [55]+5, mx_TERMCAP_CMD_BD */ '\0','\0',  'B','D','\0',
	/* [60]+5, mx_TERMCAP_CMD_ce */ 'c','e',  'e','l','\0',
	/* [65]+6, mx_TERMCAP_CMD_ch */ 'c','h',  'h','p','a','\0',
	/* [71]+5, mx_TERMCAP_CMD_cr */ 'c','r',  'c','r','\0',
	/* [76]+7, mx_TERMCAP_CMD_le */ 'l','e',  'c','u','b','1','\0',
	/* [83]+7, mx_TERMCAP_CMD_nd */ 'n','d',  'c','u','f','1','\0',
...
static struct a_termcap_control const a_termcap_control[] = {
	...
	{/* 4. mx_TERMCAP_CMD_cl */ mx_TERMCAP_CAPTYPE_STRING, 30},
	{/* 5. mx_TERMCAP_CMD_cd */ mx_TERMCAP_CAPTYPE_STRING, 38},
	{/* 6. mx_TERMCAP_CMD_ho */ mx_TERMCAP_CAPTYPE_STRING, 43},
# ifdef mx_HAVE_KEY_BINDINGS /* for now */
	{/* 7. mx_TERMCAP_CMD_BE */ mx_TERMCAP_CAPTYPE_STRING, 50},
	{/* 8. mx_TERMCAP_CMD_BD */ mx_TERMCAP_CAPTYPE_STRING, 55},
# endif
# ifdef mx_HAVE_MLE
	{/* 9. mx_TERMCAP_CMD_ce */ mx_TERMCAP_CAPTYPE_STRING, 60},
	{/* 10. mx_TERMCAP_CMD_ch */ mx_TERMCAP_CAPTYPE_STRING|a_TERMCAP_F_ARG_IDX1, 65},
	{/* 11. mx_TERMCAP_CMD_cr */ mx_TERMCAP_CAPTYPE_STRING, 71},
	{/* 12. mx_TERMCAP_CMD_le */ mx_TERMCAP_CAPTYPE_STRING|a_TERMCAP_F_ARG_CNT, 76},
	{/* 13. mx_TERMCAP_CMD_nd */ mx_TERMCAP_CAPTYPE_STRING|a_TERMCAP_F_ARG_CNT, 83},
# endif
