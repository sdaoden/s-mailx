...
"NONE", "2BIG", "ACCES", "ADDRINUSE", "ADDRNOTAVAIL", "AFNOSUPPORT",
...
"NETDOWN", "NETRESET", "NETUNREACH", "NFILE", "NOBUFS", "NODATA",
"NODEV", "NOENT", "NOEXEC", "NOLCK", "NOLINK", "NOMEM", "NOMSG",
"NOPROTOOPT", "NOSPC", "NOSR", "NOSTR", "NOSYS", "NOTCONN", "NOTDIR",
"NOTEMPTY", "NOTOBACCO", "NOTSOCK", "NOTSUP", "NOTTY", "NXIO",
"OPNOTSUPP", "OVERFLOW", "PERM", "PIPE", "PROTO", "PROTONOSUPPORT",
"PROTOTYPE", "RANGE", "ROFS", "SPIPE", "SRCH", "STALE", "TIME",
"TIMEDOUT", "TXTBSY", "WOULDBLOCK", "XDEV", NULL
};
#endif /* !su_SOURCE */
