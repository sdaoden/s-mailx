...
char const su_time_weekday_names_abbrev[su_TIME_WEEKDAY_SATURDAY +1][su_TIME_WEEKDAY_NAMES_ABBREV_LEN +1] = {
	"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"
};

char const su_time_month_names_abbrev[su_TIME_MONTH_DECEMBER +1][su_TIME_MONTH_NAMES_ABBREV_LEN +1] = {
	"Jan", "Feb", "Mar", "Apr", "May", "Jun",
	"Jul", "Aug", "Sep", "Oct", "Nov", "Dec"
};

boole
su_time_epoch_to_gregor(s64 epsec, u32 *yp, u32 *mp, u32 *dp, u32 *hourp_or_nil, u32 *minp_or_nil, u32 *secp_or_nil){
...
s64
su_time_gregor_to_epoch(u32 year, u32 month, u32 day, u32 hour, u32 min, u32 sec){
	uz jdn;
	s64 rv;
	NYD2_IN;
...
su_time_gregor_to_jdn(u32 y, u32 m, u32 d){
	/* Algorithm is taken from Communications of the ACM, Vol 6, No 8. (via third hand, plus adjustments).
	 * This algorithm is supposed to work for all dates in between 1582-10-15 (0001-01-01 but that not Gregorian)
	 * and 65535-12-31 */
	uz jdn;
	NYD2_IN;
