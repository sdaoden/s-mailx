...
STA type_toolbox<char*> const * const cs::type_toolbox = R(NSPC(su)type_toolbox<char*> const*,&su_cs_toolbox);
STA type_toolbox<char const*> const * const cs::const_type_toolbox =
		R(NSPC(su)type_toolbox<char const*> const*,&su_cs_toolbox);

STA type_toolbox<char*> const * const cs::type_toolbox_case = R(NSPC(su)type_toolbox<char*> const*,&su_cs_toolbox_case);
...
STA char const utf8::name_lower[sizeof su_UTF8_NAME_LOWER] = su_UTF8_NAME_LOWER;
...
STA char const utf32::name_lower[sizeof su_UTF32_NAME_LOWER] = su_UTF32_NAME_LOWER;
...
namespace{
	...
	static s32 a_md_marshal_setup(void *self, void const *key, uz key_len, uz digest_size);
	...
	static void a_md_marshal_del(void *self) {su_DEL(S(NSPC(su)md*,self));}
	...
	static void a_md_marshal_end(void *self, void *store) {S(NSPC(su)md*,self)->end(store);}
